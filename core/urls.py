...
from .views import (register, home, user_login, logout_view,
                    DriverListView, DriverDetailView, DriverCreateView, DriverUpdateView, DriverDeleteView,
                    ...
                    DeductionListView, DeductionDetailView, DeductionCreateView, DeductionUpdateView, DeductionDeleteView)
...
urlpatterns = [
    ...
    path('deductions/<int:pk>/update/', DeductionUpdateView.as_view(), name='deduction_update'),
